...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public sealed partial class VolumetricClouds : VolumeComponent
    {
        ...
        public TextureCurveParameter customDensityCurve = new TextureCurveParameter(new TextureCurve(new Keyframe[] { new Keyframe(0f, 0f), new Keyframe(0.2f, 1.0f), new Keyframe(0.5f, 0.7f), new Keyframe(0.8f, 1.0f), new Keyframe(1.0f, 0.0f) }), false);
        ...
        public TextureCurveParameter customErosionCurve = new TextureCurveParameter(new TextureCurve(new Keyframe[] { new Keyframe(0f, 0.9f), new Keyframe(0.2f, 1.0f), new Keyframe(0.8f, 1.0f), new Keyframe(1.0f, 0.9f) }), false);
        ...
        public TextureCurveParameter customAmbientOcclusionCurve = new TextureCurveParameter(new TextureCurve(new Keyframe[] { new Keyframe(0f, 1f), new Keyframe(0f, 0f), new Keyframe(1.0f, 0.0f) }), false);
