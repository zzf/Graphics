...
EnvironmentLighting EvaluateEnvironmentLighting(CloudRay ray, float3 entryEvaluationPointWS, float3 exitEvaluationPointWS)
{
    ...
    lighting.ambientTermTop = _AmbientProbeTop.xyz * GetCurrentExposureMultiplier();
    lighting.ambientTermBottom = _AmbientProbeBottom.xyz * GetCurrentExposureMultiplier();
